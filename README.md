...
The goal was simple:
Create a professional, easy-to-use dashboard that tracks athlete performance and helps the coach clearly demonstrate improvement.
...
I built a Power BI dashboard that tracks key performance metrics and generates monthly athlete reports.
